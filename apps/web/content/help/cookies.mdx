...
Kocteau may also record first-party product events for review and discovery health, such as feed loads, recommendation actions, starter pick actions, and review opens. These events should stay focused on product behavior and avoid sensitive metadata.
