...
<span id="recommendations-and-curation" className="block scroll-m-24" />

## Recommendations and curation

Kocteau uses reviews, ratings, saves, follows, comments, taste preferences, editorial starter picks, and similar product signals to shape discovery surfaces such as For You, Explore, track pages, and editorial modules.

Kocteau may also use aggregate product signals to help maintainers understand what is working, improve recommendation quality, and identify music that may deserve human editorial review. These systems are meant to support taste discovery, not to guarantee visibility, ranking, audience growth, or promotion for any user, artist, review, or track.
