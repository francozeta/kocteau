...
export default function ReviewCommentsButton({
  ...
  const trigger = (
    <button
      ...
      aria-expanded={open}
      className={cn(
        "inline-flex min-h-8 items-center gap-1 rounded-full border border-transparent px-2 py-1 text-[11px] font-medium text-muted-foreground/88 transition-[color,background-color,transform] duration-150 hover:bg-muted/34 hover:text-foreground active:scale-[0.96]",
